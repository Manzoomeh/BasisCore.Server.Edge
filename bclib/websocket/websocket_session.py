...
class WebSocketSession:
    ...
    Attributes:
        ...
        _on_message_receive (Callable): Message dispatcher callback
    ...
    Args:
        ...
        on_message_receive_async (Callable): Async callback for message dispatch
    ...
    def __init__(self,
        ...
        Args:
            ...
            on_message_receive_async (Callable): Message dispatcher
    ...
    async def _start_async(self) -> None:
        ...
        try:
            ...
            await self._on_message_receive(connect_msg)
            ...
            while not self.ws.closed:
                try:
                    ...
                    try:
                        await self._on_message_receive(error_msg)
    ...
    async def _send_disconnect(self, exit_code: int) -> None:
        ...
        try:
            await self._on_message_receive(disconnect_msg)
        except Exception as log_ex:
            logging.exception(
