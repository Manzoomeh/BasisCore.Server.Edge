...
class RabbitListener(ABC):
    ...
    def initialize_task_async(self, loop: asyncio.AbstractEventLoop) -> asyncio.Future:
        return loop.run_in_executor(None, self.__consuming_task)

    def __consuming_task(self):
        try:
            print(
