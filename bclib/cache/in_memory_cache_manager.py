...
class InMemoryCacheManager(SignalBaseCacheManager):
    ...
    def __add_or_update_private(self, key:"str", cache_item:"BaseCacheItem", value_item:"BaseValueItem") -> "CacheStatus":
    ...
    def cache_decorator(self, key:"str"=None, life_time:"int"=0) -> "Callable":
        ...
        def decorator(function):
            ...
            if key is not None:
                self.__add_or_update_private(key, cache_item, ArrayValueItem)
    ...
    def add_or_update(self, key: str, data: "any", life_time: int = 0) -> CacheStatus:
        ...
        """
        return self.__add_or_update_private(key, CustomCacheItem(data, life_time), ScalarValueItem)
